...
请求-应答模式：客户端将消息发送到服务器，服务器接收到消息后进行应答，最后客户端收到服务器的应答。
...
不同于请求-应答模式，Pair模式是异步的，客户端向服务器发出请求，不需要等待。
...
发布-订阅模式：这种模式下的数据是单向的，服务器发布一些带有主题的消息，客户端可以订阅主题收到与该主题相关的消息。
